...
class TestURLFixerMixin:
    ...
    def setUpClass(cls): # noqa
        ...
        cls._orig_url_field_to_representation = serializers.HyperlinkedRelatedField.to_representation
        cls._orig_image_field_to_representation = serializers.ImageField.to_representation
        ...
        serializers.HyperlinkedRelatedField.to_representation = patched_url_field_to_representation
        serializers.ImageField.to_representation = patched_image_field_to_representation
    
    @classmethod
    def tearDownClass(cls): # noqa
        serializers.HyperlinkedRelatedField.to_representation = cls._orig_url_field_to_representation
        serializers.ImageField.to_representation = cls._orig_image_field_to_representation
        super().tearDownClass() 