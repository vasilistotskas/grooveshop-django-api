...
def config_logging():
    ...
    db_log_file_path = path.join(log_dir, f"db_logs_{timestamp}.log")
    json_log_file_path = path.join(log_dir, f"json_logs_{timestamp}.log")
    ...
    logging_config = {
        ...
        "handlers": {
            ...
            "celery_logfile": {
                ...
                "backupCount": backup_count,  # how many backup files to keep, 30 days
                "formatter": "standard",
                "encoding": "utf-8",
            },
            "django_logfile": {
    ...
    return celery_log_file_path, django_log_file_path, logging_config
