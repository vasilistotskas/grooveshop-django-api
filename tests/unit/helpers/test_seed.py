...
class TestGetOrCreateDefaultImage(TestCase):
    existing_image = None
    existing_image_path = "test_image.jpg"
    existing_image_content = b"Some image content"
    non_existing_image = None
    non_existing_image_path = "non_existing_image.jpg"
    default_image = None
    default_image_path = "files/images/no_photo.jpg"
